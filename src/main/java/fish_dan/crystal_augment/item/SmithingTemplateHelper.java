package fish_dan.crystal_augment.item;
...
public class SmithingTemplateHelper {
    ...
    public static SmithingTemplateItem createTemplate(String materialName) {
        final Component UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", new ResourceLocation(Crystal_Augment.MOD_ID, materialName+"_upgrade"))).withStyle(TITLE_FORMAT);
        final Component UPGRADE_APPLIES_TO = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Crystal_Augment.MOD_ID, "smithing_template."+ materialName +"_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMAT);
        final Component UPGRADE_INGREDIENTS = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Crystal_Augment.MOD_ID, "smithing_template."+ materialName +"_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMAT);
        final Component UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Crystal_Augment.MOD_ID, "smithing_template."+ materialName +"_upgrade.base_slot_description")));
        final Component UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Crystal_Augment.MOD_ID, "smithing_template."+ materialName + "_upgrade.additions_slot_description")));
