...
public class MachineRecipeBuilder<T extends ThermalRecipe> {
    ...
    public static MachineRecipeBuilder<FluidMixerRecipe> fluid_mixer() {
        return new MachineRecipeBuilder<>(Crystal_AugmentRecipeSerializers.FLUID_MIXER_RECIPE_SERIALIZER.get());
    }

    public static MachineRecipeBuilder<EndothermicDehydratorRecipe> endothermic_dehydrator() {
        return new MachineRecipeBuilder<>(Crystal_AugmentRecipeSerializers.ENDOTHERMIC_DEHYDRATOR_RECIPE_SERIALIZER.get()).chance();
    }

    public static MachineRecipeBuilder<EndothermicDehydratorRecipe> endothermic_dehydrator_no_chance() {
        return new MachineRecipeBuilder<>(Crystal_AugmentRecipeSerializers.ENDOTHERMIC_DEHYDRATOR_RECIPE_SERIALIZER.get());
    }

    public static MachineRecipeBuilder<ComponentAssemblyRecipe> component_assembly() {
        return new MachineRecipeBuilder<>(Crystal_AugmentRecipeSerializers.COMPONENT_ASSEMBLY_RECIPE_SERIALIZER.get()).chance();
    }

    public static MachineRecipeBuilder<NitraticIgniterRecipe> nitratic_igniter() {
        return new MachineRecipeBuilder<>(Crystal_AugmentRecipeSerializers.NITRATIC_IGNITER_RECIPE_SERIALIZER.get()).chance();
    }

    public static CatalystBuilder<NitraticIgniterCatalyst> nitratic_igniter_catalyst() {
        return new CatalystBuilder<>(Crystal_AugmentRecipeSerializers.NITRATIC_IGNITER_CATALYST_SERIALIZER.get());
    }

    public static MachineRecipeBuilder<AdvancedRefineryRecipe> advanced_refinery() {
        return new MachineRecipeBuilder<>(Crystal_AugmentRecipeSerializers.ADVANCED_REFINERY_RECIPE_SERIALIZER.get());
    }
