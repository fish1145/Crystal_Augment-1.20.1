...
import fish_dan.crystal_augment.client.screens.machine.MachineComponentAssemblyScreen;
import fish_dan.crystal_augment.init.Crystal_AugmentBlocks;
import fish_dan.crystal_augment.recipe.ComponentAssemblyRecipe;
import fish_dan.crystal_augment.recipe.ComponentAssemblyRecipeManager;
...
public class ComponentAssemblyRecipeCategory extends ThermalRecipeCategory<ComponentAssemblyRecipe> {
    ...
    public ComponentAssemblyRecipeCategory(IGuiHelper guiHelper, ItemStack icon, RecipeType<ComponentAssemblyRecipe> type) {
        ...
        background = guiHelper.drawableBuilder(MachineComponentAssemblyScreen.TEXTURE, 26, 11, 128, 62)
                ...
                .build();
        name = getTextComponent(Crystal_AugmentBlocks.BLOCKS.get("component_assembly").getDescriptionId());
