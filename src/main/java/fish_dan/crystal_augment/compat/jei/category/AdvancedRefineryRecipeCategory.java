...
import fish_dan.crystal_augment.client.screens.machine.MachineAdvancedRefineryScreen;
import fish_dan.crystal_augment.init.Crystal_AugmentBlocks;
import fish_dan.crystal_augment.recipe.AdvancedRefineryRecipe;
import fish_dan.crystal_augment.recipe.AdvancedRefineryRecipeManager;
...
public class AdvancedRefineryRecipeCategory extends ThermalRecipeCategory<AdvancedRefineryRecipe> {
    ...
    public AdvancedRefineryRecipeCategory(IGuiHelper guiHelper, ItemStack icon, RecipeType<AdvancedRefineryRecipe> type) {
        ...
        background = guiHelper.drawableBuilder(MachineAdvancedRefineryScreen.TEXTURE, 26, 11, 124, 62)
                ...
                .build();
        name = getTextComponent(Crystal_AugmentBlocks.BLOCKS.get("advanced_refinery").getDescriptionId());
