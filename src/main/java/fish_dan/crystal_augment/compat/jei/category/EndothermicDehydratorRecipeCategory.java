...
import fish_dan.crystal_augment.client.screens.machine.MachineEndothermicDehydratorScreen;
import fish_dan.crystal_augment.init.Crystal_AugmentBlocks;
import fish_dan.crystal_augment.recipe.EndothermicDehydratorRecipe;
import fish_dan.crystal_augment.recipe.EndothermicDehydratorRecipeManager;
...
public class EndothermicDehydratorRecipeCategory extends ThermalRecipeCategory<EndothermicDehydratorRecipe> {
    ...
    public EndothermicDehydratorRecipeCategory(IGuiHelper guiHelper, ItemStack icon, RecipeType<EndothermicDehydratorRecipe> type) {
        ...
        background = guiHelper.drawableBuilder(MachineEndothermicDehydratorScreen.TEXTURE, 26, 11, 134, 62)
                ...
                .build();
        name = getTextComponent(Crystal_AugmentBlocks.BLOCKS.get("endothermic_dehydrator").getDescriptionId());
