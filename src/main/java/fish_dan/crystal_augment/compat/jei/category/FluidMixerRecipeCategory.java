...
import fish_dan.crystal_augment.client.screens.machine.MachineFluidMixerScreen;
import fish_dan.crystal_augment.init.Crystal_AugmentBlocks;
import fish_dan.crystal_augment.recipe.FluidMixerRecipe;
import fish_dan.crystal_augment.recipe.FluidMixerRecipeManager;
...
public class FluidMixerRecipeCategory extends ThermalRecipeCategory<FluidMixerRecipe> {
    ...
    public FluidMixerRecipeCategory(IGuiHelper guiHelper, ItemStack icon, RecipeType<FluidMixerRecipe> type) {
        ...
        background = guiHelper.drawableBuilder(MachineFluidMixerScreen.TEXTURE, 26, 11, 124, 62)
                ...
                .build();
        name = getTextComponent(Crystal_AugmentBlocks.BLOCKS.get("fluid_mixer").getDescriptionId());
