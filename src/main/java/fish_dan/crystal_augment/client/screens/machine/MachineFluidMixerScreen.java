...
import fish_dan.crystal_augment.inventory.machine.MachineFluidMixerMenu;
...
public class MachineFluidMixerScreen extends MachineScreen<MachineFluidMixerMenu> {
    ...
    public static final String TEX_PATH = Crystal_Augment.MOD_ID + ":textures/gui/container/fluid_mixer.png";
    ...
    public MachineFluidMixerScreen(MachineFluidMixerMenu container, Inventory inv, Component titleIn) {
        ...
        texture = TEXTURE;
        info = generatePanelInfo("info.crystal_augment.machine_fluid_mixer");
        name = "fluid_mixer";
    }
